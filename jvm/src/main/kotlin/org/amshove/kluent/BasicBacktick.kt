...
infix fun <T: Any> T.`should be equivalent to`(expected: Pair<T, ((EquivalencyAssertionOptions) -> EquivalencyAssertionOptions)?>) = this.shouldBeEquivalentTo(expected.first, expected.second)

@ExperimentalStdlibApi
infix fun <T: Any> T.`should not be equivalent to`(expected: Pair<T, ((EquivalencyAssertionOptions) -> EquivalencyAssertionOptions)?>) = this.shouldNotBeEquivalentTo(expected.first, expected.second)
