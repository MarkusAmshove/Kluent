...
class ShouldBeEquivalentTo {
    ...
    fun `pass should be equivalent to as includedProperties are equal`() {
        ...
        // assert
        team1 `should be equivalent to` (team2 to { options -> options.including(Team::persons) })
    }
    ...
    fun `pass should not be equivalent to as includedProperties are different`() {
        ...
        // assert
        team1 `should not be equivalent to` (team2 to { options -> options.including(Team::persons) })
    }
