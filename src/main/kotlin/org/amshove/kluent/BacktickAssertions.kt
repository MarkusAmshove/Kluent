...
infix fun Byte.`should be greater or equal to`(theOther: Byte) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)
infix fun Short.`should be greater or equal to`(theOther: Short) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)
infix fun Int.`should be greater or equal to`(theOther: Int) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)
infix fun Long.`should be greater or equal to`(theOther: Long) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)
infix fun Float.`should be greater or equal to`(theOther: Float) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)
infix fun Double.`should be greater or equal to`(theOther: Double) = assertTrue("Expected $this to be greater or equal than $theOther", this >= theOther)

infix fun Byte.`should not be greater or equal to`(theOther: Byte) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
infix fun Short.`should not be greater or equal to`(theOther: Short) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
infix fun Int.`should not be greater or equal to`(theOther: Int) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
infix fun Long.`should not be greater or equal to`(theOther: Long) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
infix fun Float.`should not be greater or equal to`(theOther: Float) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
infix fun Double.`should not be greater or equal to`(theOther: Double) = assertTrue("Expected $this to be greater than $theOther", this < theOther)
